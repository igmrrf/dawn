...
import messageImage from "../../../assets/Landing/img/2.jpg";
			...
			<div className="message">
				<Container>
					<Header
						...
						A
						Message"
						paragraph="Chat with our live chat or drop a message"
					/>
					...
					<Row>
						<Col md={6}>
							...
							<div className="d-flex justify-content-center align-content-center">
								<button className="brownBtn" onClick={this.onSubmitContact}>
									Submit
								</button>
							</div>
						</Col>

						<Col md={6} className="message-image-card" data-aos="fade-up">
							<img
								src={messageImage}
