  ...
  render() {
    ...
    return (
      <div className="register">
        <Container>
          <Header
            paragraph="Create an account today and join millions of investors making money at homes"
            heading="Sign Up"
          />
              ...
              <Card className="register-card" data-aos="fade-up">
                <Card.Body>
                  <Form>
                    <Form.Group className="pb-1">
                      ...
                      >
                        ...
                        Enter First Name: <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Control
                        id="first_name"
                        type="text"
                    ...
                    <Form.Group className="pb-1">
                      ...
                      >
                        ...
                        Enter Last Name: <span className="text-danger">*</span>
                      </Form.Label>
                      <Form.Control
                        id="last_name"
                        name="last_name"
                    ...
                    <Form.Group className="pb-1">
                      ...
                      >
                        ...
                        Enter Secret Key: <span className="text-danger">*</span>{" "}
                        <span>
                          <div
                            style={{
                              display: "inline",
                  ...
                  <div className="d-flex justify-content-center align-content-center">
                    <button disabled={isLoading} onClick={this.onRegister}>
                      {isLoading && (
                        <div>
                          <Spinner
                            animation="border"
